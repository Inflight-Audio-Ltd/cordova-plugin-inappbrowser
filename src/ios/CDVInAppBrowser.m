...
- (void)createViews
{
    ...
    self.spinner.frame = CGRectMake(454.0, 231.0, 80.0, 80.0);
    ...
    self.hudView = [[UIView alloc] initWithFrame:CGRectMake(427, 280, 170, 170)];
    self.hudView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
    self.hudView.clipsToBounds = YES;
    ...
    [self.hudView addSubview:self.captionLabel];
